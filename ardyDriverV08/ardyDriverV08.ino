...
const int bin3 = 9; //index array of bin3 location
const long cycleTime = 400;
...
int actuatorSpeed = 150; //range from 0 to 255
...
void loop(){
  checkButton();
  sonarCheck();
  postCycleTime = millis();
  actualCycleTime = postCycleTime - preCycleTime;
  if(actualCycleTime > cycleTime){
    updateConveyorArray();
    preCycleTime = postCycleTime;
  }
